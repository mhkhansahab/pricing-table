import { p as proxyCustomElement, H, c as createEvent, h } from './p-6082d300.js';
...
const PricingTable$1 = /*@__PURE__*/ proxyCustomElement(class PricingTable extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return PricingTableStyle0; }
}, [1, "pricing-table", {
        "loading": [32],
        "products": [32]
    }]);
...
function defineCustomElement$1() {
    ...
    const components = ["pricing-table"];
    components.forEach(tagName => { switch (tagName) {
        case "pricing-table":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PricingTable$1);
            }
            break;
    } });
}
...
const PricingTable = PricingTable$1;
const defineCustomElement = defineCustomElement$1;

export { PricingTable, defineCustomElement };

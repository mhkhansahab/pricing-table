...
const PricingTable = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "card-container" }, (_a = this.products) === null || _a === void 0 ? void 0 : _a.map(product => {
            var _a;
            return (index.h("div", { class: "card" }, index.h("div", { class: "card-title" }, product === null || product === void 0 ? void 0 : product.name), index.h("div", { class: `price-container ${(product === null || product === void 0 ? void 0 : product.default_price) ? '' : 'visibility-hidden'}` }, "\u00A3", (product === null || product === void 0 ? void 0 : product.default_price) || 0, index.h("div", null, "per month")), (product === null || product === void 0 ? void 0 : product.default_price) ? (index.h("button", { type: "button", class: "card-button", onClick: () => this.handleClick(product) }, "Subscribe")) : (index.h("button", { type: "button", class: "card-button", onClick: () => this.handleClick(product) }, "Contact Sales")), index.h("div", { class: "feature-container" }, index.h("div", { class: "feature-title" }, "This includes:"), index.h("ul", { class: "feature-ul-container" }, (_a = product === null || product === void 0 ? void 0 : product.features) === null || _a === void 0 ? void 0 : _a.map(feature => (index.h("li", { class: "feature" }, feature === null || feature === void 0 ? void 0 : feature.name)))))));
        })));
    }
};
